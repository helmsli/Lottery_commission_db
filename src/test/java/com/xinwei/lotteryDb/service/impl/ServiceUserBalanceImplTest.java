...
public class ServiceUserBalanceImplTest extends ServiceUserBalanceImpl {
	...
	public void testUpdateUserBalance() {
		...
		assertEquals("testUpdateUserBalance result:",UserBalanceApplyConst.RESULT_SUCCESS_init,userBalanceApplyResult.getResult());
		...
		userBalance=userBalances.get(0);
		assertEquals("testUpdateUserBalance 增加余额 error",UserBalanceApplyConst.RESULT_SUCCESS,userBalanceApplyResult.getError());
		
		assertEquals("testUpdateUserBalance 增加余额 result",UserBalanceApplyConst.RESULT_SUCCESS,userBalanceApplyResult.getResult());
		...
		assertEquals("testUpdateUserBalance 增加余额 error",UserBalanceApplyConst.ERROR_CHECKSUM_NOTEQUAL,userBalanceApplyResult.getError());
		
		assertEquals("testUpdateUserBalance 增加余额 result",UserBalanceApplyConst.RESULT_FAILURE,userBalanceApplyResult.getResult());
		...
		//测试 transaction 不正确，不能更新,initUserBalance--数据库初始余额， userbalance 操作后的数据库余额
				...
				assertEquals("testUpdateUserBalance 增加余额 error",UserBalanceApplyConst.ERROR_TRANSACTION_NOTEQUAL,userBalanceApplyResult.getError());
